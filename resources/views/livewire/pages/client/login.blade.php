...
<div class="relative z-10 py-16 md:py-20 min-h-[85vh] flex items-center justify-center">
    ...
    <div class="container mx-auto px-6 max-w-md w-full relative">
        @section('title', 'Login Portal Klien — DBAIK Digital Agency')
        ...
        <div class="glass-panel p-8 rounded-3xl shadow-2xl relative overflow-hidden" style="border-color: rgba(6, 182, 212, 0.15); box-shadow: 0 20px 50px rgba(0,0,0,0.4), 0 0 30px rgba(6, 182, 212, 0.05);">
            ...
            <div class="text-center mb-8">
                <span class="text-[10px] font-bold tracking-widest text-cyan-400 uppercase">ACCESS PANEL</span>
                <h2 class="text-3xl font-black text-white mt-2">Portal Klien</h2>
                <p class="text-xs text-slate-400 mt-2">Log in untuk akses demo software, billing tagihan, dan tiket support Anda.</p>
            </div>
            ...
            <form wire:submit.prevent="login" class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" id="email" wire:model.defer="email" required
                        class="w-full bg-slate-900/50 border border-white/10 rounded-2xl px-5 py-4 text-sm text-white focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all placeholder-slate-500"
                ...
                <div class="space-y-2" x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" id="password" wire:model.defer="password" required
                            class="w-full bg-slate-900/50 border border-white/10 rounded-2xl px-5 py-4 pr-12 text-sm text-white focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all placeholder-slate-500"
                            placeholder="••••••••">
                ...
                <!-- Submit Button -->
                <button type="submit" class="w-full btn-primary py-4 rounded-2xl flex items-center justify-center font-bold tracking-wider uppercase text-xs mt-8" style="background: linear-gradient(135deg, var(--gold-400), var(--gold-500)); color: black; box-shadow: 0 6px 20px rgba(6, 182, 212, 0.2);">
                    <span>Masuk Portal</span>
                </button>
            </form>

            <div class="mt-8 pt-6 border-t border-white/5 text-center">
                <p class="text-xs text-slate-400">Belum memiliki akun client? <a href="{{ route('client.register') }}" class="text-cyan-400 font-bold hover:underline">Daftar Sekarang</a></p>
            </div>
        </div>
    </div>
</div>
